...
git clone --depth 1 --branch v1.21.1 https://github.com/Blosc/c-blosc "${download_dir}/c-blosc"
git clone --depth 1 --branch v2.4.1 https://github.com/Blosc/c-blosc2 "${download_dir}/c-blosc2"
...
git clone --depth 1 --branch v1.14 https://github.com/ebiggers/libdeflate "${download_dir}/libdeflate"
git clone --depth 1 --branch v1.0.0 https://github.com/xiph/rav1e.git "${download_dir}/rav1e"
git clone --depth 1 --branch v0.10.1 https://github.com/AOMediaCodec/libavif "${download_dir}/libavif"
git clone --depth 1 --branch v0.5.1 https://github.com/videolan/dav1d "${download_dir}/dav1d"
git clone --depth 1 --branch v3.4.0 https://aomedia.googlesource.com/aom "${download_dir}/aom"
git clone --depth 1 --branch 2.13.1 https://github.com/mm2/Little-CMS "${download_dir}/Little-CMS"
